...
final class ProductBuilderTest extends TestCase
{
    ...
    public function parseArray(): void
    {
        ...
        foreach ($products as $index => $product) {
            ...
            self::assertSame(@$data[$index]['comment'], $product->getComment());
            self::assertSame(@$data[$index]['category']['name'], $product->getCategoryName());
           // self::assertSame(@$data[$index]['category']['uuid'], $product->getCategoryUuid());
