...
final class ProductBuilder implements ProductBuilderInterface
{
    ...
    private function build(array $product, Currency $currency): Product
    {
        return new Product(
            ...
            $this->getFromKey('comment', $product),
            $this->getFromKey('name', isset($product['category']) ? $product['category'] : []),
            $this->getUuidFromKey('uuid', isset($product['category']) ? $product['category'] : []),
